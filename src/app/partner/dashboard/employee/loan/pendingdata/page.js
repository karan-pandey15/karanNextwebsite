...
const PendingData = () => {
  ...
  const handleDelete = async (_id) => {
    try {
      const response = await fetch(
        `https://api.addrupee.com/api/p_deletePendingData/${_id}`,
        {
          method: "DELETE",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const handleAdminDelete = async (_id) => {
    try {
      ...
      if (isConfirmed) {
        const response = await fetch(
          `https://api.addrupee.com/api/deletepartnerPendingData/${_id}`,
          {
            method: "DELETE",
            credentials: "include",
            headers: { "Content-Type": "application/json" },
  ...
  const handleSubmit = () => {
    if (selectedData && formType === "Approved") {
      ...
      axios
        .post(
          "https://api.addrupee.com/api/p_submit-approved-data",
          approvedData,
          {
            headers: {
  ...
  const handleRejectSubmit = () => {
    if (selectedData && formType === "Rejected") {
      ...
      axios
        .post(
          "https://api.addrupee.com/api/p_submit-rejct-data",
          approvedData,
          {
            headers: {
              "Content-Type": "application/json",
