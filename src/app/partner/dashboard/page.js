...
const PartnerDashboard = () => {
  ...
  const fetchAlldata = async () => {
    try {
      let data = await fetch(
        `https://api.addrupee.com/api/fetchpartnerAlldata?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
  ...
  const fetchPendingData = async () => {
    ...
    try {
      let data = await fetch(
        `https://api.addrupee.com/api/getpendingpartnerdatas/${Status}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchApprovedData = async () => {
    ...
    try {
      let data = await fetch(
        `https://api.addrupee.com/api/getdisbursedpartnerdatas/${Status}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchRejectedData = async () => {
    ...
    try {
      let data = await fetch(
        `https://api.addrupee.com/api/getrejectedpartnerdatas/${Status}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchCardAlldata = async () => {
    try {
      let data = await fetch(
        `https://api.addrupee.com/api/fetchCardpartnerAlldata?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchCardPendingData = async () => {
    ...
    try {
      let data = await fetch(
        `https://api.addrupee.com/api/getCardpendingpartnerdatas/${Status}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchCardApprovedData = async () => {
    ...
    try {
      let data = await fetch(
        `https://api.addrupee.com/api/getCarddisbursedpartnerdatas/${Status}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchCardRejectedData = async () => {
    ...
    try {
      let data = await fetch(
        `https://api.addrupee.com/api/getCardrejectedpartnerdatas/${Status}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
          ...
          <div className="container" style={{ padding: "20px" }}>
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-6 col-lg-3 my-2 m-md-3 dashboard_card  dashboard_card-1">
                <Link
                  ...
                  href="/partner/dashboard/employee/loan/loginleadsdata"
                >
              ...
              <div className="col-12 col-md-6 col-lg-3 my-2 m-md-3 dashboard_card  dashboard_card-2">
                <Link
                  style={{ textDecoration: "none" }}
                  href="/partner/dashboard/employee/loan/pendingdata"
                >
                  <div className="card-inner">
              ...
              <div className="col-12 col-md-6 col-lg-3 my-2 m-md-3 dashboard_card  dashboard_card-3">
                <Link
                  style={{ textDecoration: "none" }}
                  href="/partner/dashboard/employee/loan/disburseddata"
                >
                  <div className="card-inner">
              ...
              <div className="col-12 col-md-6 col-lg-3 my-2 m-md-3 dashboard_card  dashboard_card-4">
                <Link
                  style={{ textDecoration: "none" }}
                  href="/partner/dashboard/employee/loan/rejecteddata"
                >
                  <div className="card-inner">
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-6 col-lg-3 my-2 m-md-3 dashboard_card  dashboard_card-1">
                <Link
                  style={{ textDecoration: "none" }}
                  href="/partner/dashboard/employee/card/loginleadsdata"
                >
                  <div className="card-inner">
                    <h3 className="fs-5 fs-bold text-white">LOGIN LEADS</h3>
                    <BsFillArchiveFill
                  ...
                  <h5 className="text-white">{allCardData.length}</h5>
                </Link>
              </div>
              <div className="col-12 col-md-6 col-lg-3 my-2 m-md-3 dashboard_card  dashboard_card-2">
                <Link
                  style={{ textDecoration: "none" }}
                  href="/partner/dashboard/employee/card/pendingdata"
                >
                  <div className="card-inner">
                    <h3 className="fs-5 fs-bold text-white">PENDING</h3>
                    <BsFillGrid3X3GapFill
                  ...
                  <h5 className="text-white">{pendingCardData.length}</h5>
                </Link>
              </div>
              <div className="col-12 col-md-6 col-lg-3 my-2 m-md-3 dashboard_card  dashboard_card-3">
                <Link
                  style={{ textDecoration: "none" }}
                  href="/partner/dashboard/employee/card/disburseddata"
                >
                  <div className="card-inner">
                    <h3 className="fs-5 fs-bold text-white">DISBURSED</h3>
                    <BsPeopleFill
                  ...
                  <h5 className="text-white">{approvedCardData.length}</h5>
                </Link>
              </div>
              <div className="col-12 col-md-6 col-lg-3 my-2 m-md-3 dashboard_card  dashboard_card-4">
                <Link
                  style={{ textDecoration: "none" }}
                  href="/partner/dashboard/employee/card/rejecteddata"
                >
                  <div className="card-inner">
                    <h3 className="fs-5 fs-bold text-white">REJECTED</h3>
                    <BsFillBellFill
                  ...
                  <h5 className="text-white">{rejectCardData.length}</h5>
                </Link>
              </div>
            </div>
          </div>
