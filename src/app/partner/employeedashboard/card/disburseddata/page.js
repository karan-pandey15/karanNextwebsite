  ...
  useEffect(() => {
    const fetchAlldata = async () => {
      ...
      let data = await fetch(
        `https://api.addrupee.com/api/p_card_approved-data/${email}?Status=${Status}&filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
                  ...
                  <div class="modal-body">
                    {selectedRowData && (
                      <div>
                        ...
                        <p>
                          Card Issue Date: {selectedRowData.Card_Issue_Date}
                        </p>
