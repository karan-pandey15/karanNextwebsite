...
const ExitedCandidate = () => {
  ...
  const filteredData = sortedData.filter((data) => {
    ...
    const lowercaseData = {
      ...
      Exit_Date: (data.Exit_Date || "").toLowerCase(),
    };
    ...
    return (
      ...
      lowercaseData.Exit_Date.includes(searchString)
    );
  });
                  ...
                  {selectedRowData && (
                    <div>
                      ...
                      <p>
                        Exit Date:{" "}
                        {new Date(
                          selectedRowData.Exit_Date
                        ).toLocaleDateString()}
                      </p>
                      <p>
                        Exit Description: {selectedRowData.Exit_Description}
                      </p>
                      <p>
                        Applied Date:{" "}
                        {new Date(
...
export default ExitedCandidate;
