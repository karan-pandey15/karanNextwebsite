              ...
              <div className="row mb-3">
                ...
                >
                  <p style={{ fontSize: "18px" }}>
                    ...
                    in-person visits, offering personalized credit options based
                    on credit history and preferences. Transparent information
                    empowers users to make informed choices, with a streamlined
                    application process for swift approvals. The platform
                    simplifies comparisons of lenders and card issuers for the
                    best deals. Online security is a top priority. AddRupee and
                    trusted platforms simplify finance, granting control and
                    adaptability for borrowing and spending needs. In summary,
                    AddRupee represents the shift towards hassle-free, secure,
                    and adaptable financial solutions in the modern era.{" "}
                  </p>
                </div>
              </div>
            </div>
