...
import MaapaFoundation from "../../../../../public/MaapaFoundation.png";
import MaapaQR from "../../../../../public/MaapaQR1.png";
          ...
          <div style={{ paddingTop: "30px" }}>
            <p>
              ...
              <Link
                ...
                href={"https://www.maapafoundation.org"}
              >
                Maapa Foundation
              </Link>
            </p>
            ...
            {silveCheckBox ? (
              <div>
                <h1 style={{ color: "#c1121f", paddingTop: "10px" }}>3999/-</h1>
                <p style={{ color: "gray" }}>
            ...
            {goldCheckBox ? (
              <div>
                <h1 style={{ color: "#c1121f", paddingTop: "10px" }}>9999/-</h1>
                <p style={{ color: "gray" }}>
            ...
            >
              ...
              <div className="col-12 col-lg-4 col-md-6">
                <Link href={"https://www.maapafoundation.org"}>
                  <Image
                    style={{ width: "350px", height: "350px" }}
                    src={MaapaFoundation}
                    alt="Maapa Foundation QR"
